                                        ...
                                        <form id="js-login" novalidate="" method="post" action="{{route('register')}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-6 pr-1">
                                                    <input type="text" id="fname" class="form-control" placeholder="First Name" name="name" required>
...
{{--                                                    <input type="text" id="lname" class="form-control" placeholder="Last Name" required>--}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="userpassword" class="form-control" placeholder="确认密码"  name="password_confirmation"required>
